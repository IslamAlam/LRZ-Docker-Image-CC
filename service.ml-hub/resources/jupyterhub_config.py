...
# --- Authenticator ---
c.Authenticator.admin_users = {"admin","root"} # override in your config when needed, for example if you use a different authenticator (e.g. set Github username if you use GithubAuthenticator)
